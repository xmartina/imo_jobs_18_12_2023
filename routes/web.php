...
//     }
// );
Route::get('pricing', [Web\PricingController::class, 'index'])->name('front.pricing');
...
Route::middleware('xss', 'setLanguage')->group(function () {
    ...
    Route::get('/get-cities-search', [Web\HomeController::class, 'getCitiesSearch'])->name('get.cities.search');
    Route::get('/get-states-search', [Web\HomeController::class, 'getStatesSearch'])->name('get.states.search');
    ...
    Route::get('/pricing', function () {
        return view('front_web.pricing.index');
    })->name('front.pricing');
