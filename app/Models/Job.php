...
class Job extends Model
{
    ...
    protected $appends = ['country_name', 'state_name', 'city_name', 'closes_in_days', 'posted_at'];
    ...
    public function getClosesInDaysAttribute()
    {
        $now = Carbon::now();
        return $now->diffInDays($this->job_expiry_date);
    }
