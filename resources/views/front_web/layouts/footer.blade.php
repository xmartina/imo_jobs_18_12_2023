    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-12 col-sm-7">
                <p class="d-block text-dark my-4 text-center">
            ...
            <div class="col-12 col-sm-6">
                <form id="newsLetterForm">
                    <div class="email d-flex">
                        ...
                        <input type="email" id="mc-email" name="email" placeholder="{{__('web.enter_your_mail')}}" class="text-sm text-muted"
        ...
        <div class="row justify-content-between mt-5">
            ...
            <div class="col-12 text-center mt-lg-5 mt-4
                        copy-right border-1 border-top">
