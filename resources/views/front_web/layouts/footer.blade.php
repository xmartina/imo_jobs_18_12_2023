        ...
        <div class="row justify-content-start">
            <div class="footer-col-1 col-md-3 col-sm-12">
                <div id="block-7" class="widget widget_block widget_media_image">
                    <figure class="wp-block-image size-full text-start"><img decoding="async" src="wp-content/uploads/2023/03/jobhub-logo.svg" alt="" class="wp-image-2193"></figure>
            ...
            <div class="footer-col-2 col-md-2 col-xs-6">
                <div id="nav_menu-2" class="widget widget_nav_menu"><h6 class="mb-20">Resources</h6><nav class="menu-resources-container" aria-label="Resources"><ul id="menu-resources" class="menu"><li id="menu-item-155" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-155"><a href="about-us/index.htm">About Us</a></li>
                            <li id="menu-item-153" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-153"><a href="candidates/index.htm">Candidates</a></li>
                            <li id="menu-item-154" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-154"><a href="contact-us/index.htm">Contact Us</a></li>
                        </ul></nav></div>            </div>
            ...
            <div class="footer-col-6 col-md-3 col-sm-12">
                <div id="block-10" class="widget widget_block"><h6 class="mb-20">Download App</h6></div><div id="block-11" class="widget widget_block"><p class="small">Download our Apps and get extra 15% Discount on your first Order…!</p></div><div id="block-12" class="widget widget_block"><div class="d-flex mt-15"><a class="mr-5" href="#"><img decoding="async" src="wp-content/uploads/2023/03/app-store.svg" width="102" alt="joxBox"></a><a href="#"><img decoding="async" width="102" src="wp-content/uploads/2023/03/google-play.svg" alt="joxBox"></a></div></div>            </div>
        </div><!-- .row -->
    </div><!-- .container -->
    <div class="container">
        <div class="footer-bottom mt-50">
            <div class="row gy-3">
                <div class="col-md-6">
                    <span class="font-xs color-text-paragraph">Copyright &copy; 2023. JobBox all right reserved</span>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-between">
                <div>
                    <a href="my-account/lost-password/index.htm" class="btn-link">Lost your password?</a>
                </div>
                <div>
...
@include('front_web/layouts/footer_parts/register_popup_modal')
